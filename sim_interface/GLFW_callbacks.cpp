...
void UIctr::Keyboard(int key, int scancode, int act, int mods)
{
    ...
    if (act==GLFW_RELEASE && key==GLFW_KEY_B){
        buttonRead.key_b= true;
    }

    if (act==GLFW_RELEASE && key==GLFW_KEY_C){
        buttonRead.key_c= true;
    }

    if (act==GLFW_RELEASE && key==GLFW_KEY_M){
        buttonRead.key_m= true;
    }

    if (act==GLFW_RELEASE && key==GLFW_KEY_V){
        buttonRead.key_v= true;
    }
    ...
    if (act==GLFW_RELEASE && key==GLFW_KEY_T){
        buttonRead.key_t= true;
    }
    ...
    if (act==GLFW_RELEASE && key==GLFW_KEY_U){
        buttonRead.key_u= true;
    }
...
UIctr::ButtonState UIctr::getButtonState() {
    ...
    buttonRead.key_h= false;
    buttonRead.key_j= false;
    buttonRead.key_b= false;
    buttonRead.key_c= false;
    buttonRead.key_m= false;
    buttonRead.key_v= false;
    buttonRead.key_r= false;
    buttonRead.key_f= false;
    buttonRead.key_t= false;
    buttonRead.key_g= false;
    buttonRead.key_u= false;
    buttonRead.key_space= false;
    return tmp;
}